...
import TopNavBar from "../../../presentation/components/topNavBar/TopNavBar";
import {Product} from "model/productModel";

const stripePromise = loadStripe('pk_test_51R6oAbFLPEQ7E5VhHrRH2Pfv9Tz1bj5n80Qpej3eTrZOayzrJCt4oACyu1mu5dCno5DXImE4Uhe606XFnIkJGwdt00anS8AGEy');
            ...
            <div className={styles.cartDetails}>
                <div className={styles.cartItems}>
                    ...
                    {cartItems.map((product, idx) => (
                        <div key={idx} className={styles.cartItemRow} onClick={() => handleProductDetailNavigation(product, )}>
                            <div>
                                <img src={product.image_main} alt={product.name} className={styles.productImage}/>
