...
import styles from "./ProductCellListView.module.css";
import { useTranslation } from "react-i18next";

const ProductCellListView: React.FC = () => {
        ...
        <div className={styles.card}>
            <div className={styles.wrapper}>
                ...
                <div className={styles.cardImage}>
                    <img src={'assets/fridgeSample.jpeg'} alt={'Product Image'}/>
                </div>

                {/* Product Content */}
                <div className={styles.content}>
                    <p className={styles.title}>Սառնարան ARTEL HD-276 FN White</p>
                </div>

                <div className={styles.leftSideContainer}>
                    <div className={styles.priceContainer}>
                        <p className={`${styles.title} ${styles.price}`}>139 900֏</p>
                        <p className={`${styles.title} ${styles.price} ${styles.oldPrice}`}>&nbsp;180 000֏</p>
                    </div>
